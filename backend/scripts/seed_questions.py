...
def seed_questions():
    with app.app_context():
        topic = Topic.query.filter_by(name="Binomial Expansion").first()
        if not topic:
            print("Topic 'Binomial Expansion' not found. Make sure it exists in the database.")
            return
        ...
        try:
            db.session.commit()
            print(f"{len(questions)} questions added to the 'BinomialExpansion' topic.")
